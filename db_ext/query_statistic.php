...
// SQL 語法
$sqlstr = "SELECT count(*) as f1, sum(height) as h1, avg(height) as h2, max(height) as h3, min(height) as h4, sum(weight) as w1, avg(weight) as w2, max(weight) as w3, min(weight) as w4 FROM person ";
