...
<p>預防網址 GET 被改掉 (php_uid_safe)</p>
<ul>
    <li><a href="php_uid_safe/">php_uid_safe</a></li>
</li>
</ul>
...
<h2>Class 02 (2022/06/23)</h2>

<p>九九乘法練習 (game99)</p>
<ul>
    <li>練習圖檔下載：<a href="game99/images_game99.zip">images_game99.zip</a></li>
...
<h2>Class 01 (2022/06/21)</h2>

<p>自我介紹 (intro)</p>
<ul>
    <li>第一個php程式 (嵌入式) <a href="intro/test.php">test.php</a> [<a href="show_source.php?dir=intro&amp;file=test.php">查看原始碼</a>]</li>
    <li>程式與網頁分離的概念 <a href="intro/intro.php">intro.php</a> [<a href="show_source.php?dir=intro&amp;file=intro.php">查看原始碼</a>]</li>
</ul>
